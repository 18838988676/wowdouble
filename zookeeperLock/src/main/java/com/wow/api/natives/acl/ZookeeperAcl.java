package com.wow.api.natives.acl;
 ...
 * CREATOR_ALL_ACL 拥有者权限
 * OPEN_ACL_UNSAFE 开放的权限
 */
public class ZookeeperAcl {
    ...
    public ZookeeperAcl(Watcher watcher) throws Exception {
        ...
        //对zookeeper进行权限限制,相当于账号密码
        zk.addAuthInfo(scheme,auth.getBytes());
    }


    /***
     * 创建持久类型,OPEN_ACL_UNSAFE 所有都可访问
     * @param path
     * @param data
     * @return
     * @see ZooKeeperMain
    ...
    /***
     * 创建持久类型 CREATOR_ALL_ACL 创建者zookeeper可访问
     * @param path
     * @param data
     * @return
     * @see ZooKeeperMain
